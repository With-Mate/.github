...
3) Open the terminal on your laptop
4) enter git clone "link" command
5) Go to your local WithMate-Fe folder: cd WithMate-Fe
6) (Important) Go to the Withmate-Fe folder and enter the cd home command once more
7) Command input: yarn dev 
8) Done! Just go to the local link from 6 commands. Enjoy withmate!
